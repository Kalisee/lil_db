...
$query = "INSERT INTO player_stats (sport_name, player_name, Team, Hometown, Description) VALUES('".$sp."','".$pl."','".$t."','".$h."','".$d."')"; 

if($query_run = mysqli_query($con, $query)){
	echo str_repeat('&nbsp;', 10).$pl." added to the ".$t." in Lil' DB";
} else {
	echo "failure";
}
